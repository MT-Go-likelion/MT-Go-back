...
class lodgingMain(models.Model):
    ...
    peakWeekendPrice = models.IntegerField(default=0)
    peakWeekdayPrice = models.IntegerField(default=0)
    lowWeekendPrice = models.IntegerField(default=0)
    lowWeekdayPrice = models.IntegerField(default=0)
